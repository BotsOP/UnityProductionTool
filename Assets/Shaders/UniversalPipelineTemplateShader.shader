...
Shader "Universal Render Pipeline/Custom/Physically Based Example"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _AmbientOcclusionMap2;
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                float3 normalsTSUnderneath = UnpackNormal(tex2D(_NormalMap2, input.uv));
                float3 normalsTSOnTop = lerp(normalsTSUnderneath, surfaceData.normalTS, surfaceData.alpha);

                #if _NORMALMAP
                half3 normalWS = TransformTangentToWorld(normalsTSOnTop,
                ...
                // below with your own.
                BRDFData brdfData;
                half3 colorUnderneath = tex2D(_BaseMap2, input.uv);
                half3 colorOnTop = lerp(colorUnderneath, surfaceData.albedo, surfaceData.alpha);
                InitializeBRDFData(colorOnTop, surfaceData.metallic, surfaceData.specular, surfaceData.smoothness, surfaceData.alpha, brdfData);
